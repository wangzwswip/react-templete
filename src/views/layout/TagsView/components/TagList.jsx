...
import tagStyles from './TagsList.module.less'
    ...
    return (
      <>
        <Scrollbars
          ...
          renderView={(props) => (
            <div {...props} className={tagStyles.scrollbarContainer}/>
          )}
          renderTrackVertical={(props) => (
            <div {...props} className={tagStyles.scrollbarTrackVertical} />
          )}>
            <ul className={tagStyles.tagsWrap} ref={this.tagListContainer}>
            {taglist.map((tag) => (
              <li key={tag.path}>
                <Tag
        ...
        {menuVisible ? (
          <ul
            className={tagStyles.contextmenu}
